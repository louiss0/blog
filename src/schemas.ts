...
export const titleSchema = z.string().max(60).min(10).refine(isSpaced, {
...
const layoutSchema = z.undefined({
  invalid_type_error:
    "Please don't use layouts you are in content collections If you have them. Then put them in pages instead",
});
...
export const draftAndPubDateSchema = draftAndNoPubDateSchema.or(
  noDraftAndPubDateSchema,
);
