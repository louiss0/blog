...
interface IEnum {
     ...
     * @returns Simple enum object.
     */
    extend<TEnum extends AnySimpleEnum, TExtra extends EnumPrimitive>(srcEnum: TEnum, extraValues: TExtra[]): SimpleEnumExtended<TEnum, TExtra>;
    /**
     ...
     * @returns Labeled enum object.
     */
    extend<TEnum extends AnyLabeledEnum, const TExtra extends EnumSourceObject>(srcEnum: TEnum, extraObj: TExtra): LabeledEnumExtended<TEnum, TExtra>;
    /**
     ...
     * @returns Labeled enum object.
     */
    exclude<TEnum extends AnyLabeledEnum, TKey extends InferKey<TEnum>>(srcEnum: TEnum, keys: TKey[]): LabeledEnumExcludedByKeys<TEnum, TKey>;
    /**
     ...
     * @returns Labeled enum object.
     */
    exclude<TEnum extends AnyLabeledEnum, TValue extends InferValue<TEnum>>(srcEnum: TEnum, values: TValue[]): LabeledEnumExcludedByValues<TEnum, TValue>;
    /**
     ...
     * @returns Simple enum object.
     */
    exclude<TEnum extends AnySimpleEnum, TValue extends InferValue<TEnum>>(srcEnum: TEnum, values: TValue[]): SimpleEnumExcluded<TEnum, TValue>;
}
/**
 ...
 */
type SimpleEnum<T extends EnumPrimitive> = {
    /**
 ...
 * @template T Object type (defining types of keys and correspoding values).
 */
type LabeledEnum<T extends EnumSourceObject> = {
    /**
     * Object mapping keys to values (mutations prevented with `Object.freeze`).
     * Can be used for accessing values by keys using dot syntax.
     *
 ...
 */
type InferValue<T extends Pick<AnySimpleEnum | AnyLabeledEnum, 'values'>> = EnumToUnion<ReturnType<T['values']>[number]>;
/**
 ...
 */
type InferKey<T extends Pick<AnyLabeledEnum, 'keys'>> = EnumToUnion<ReturnType<T['keys']>[number]>;
...
type EnumSourceObject = Record<EnumPrimitive, EnumPrimitive>;
type AnySimpleEnum = SimpleEnum<EnumPrimitive>;
type AnyLabeledEnum = LabeledEnum<EnumSourceObject>;
type SimpleEnumExtended<TEnum extends AnySimpleEnum, TExtra extends EnumPrimitive> = SimpleEnum<InferValue<TEnum> | TExtra>;
type LabeledEnumExtended<TEnum extends AnyLabeledEnum, TExtra extends EnumSourceObject> = LabeledEnum<Prettify<TEnum['accessor'] & TExtra>>;
type SimpleEnumExcluded<TEnum extends AnySimpleEnum, TValue extends InferValue<TEnum>> = SimpleEnum<Exclude<InferValue<TEnum>, TValue>>;
type LabeledEnumExcludedByKeys<TEnum extends AnyLabeledEnum, TKey extends InferKey<TEnum>> = LabeledEnum<Prettify<Omit<TEnum['accessor'], TKey>>>;
type LabeledEnumExcludedByValues<TEnum extends AnyLabeledEnum, TValue extends InferValue<TEnum>> = LabeledEnum<Prettify<Pick<TEnum['accessor'], {
    [K in keyof TEnum['accessor']]: TEnum['accessor'][K] extends TValue ? never : K;
}[keyof TEnum['accessor']]>>>;

/** @ignore */
declare const Enum: IEnum;

export { Enum, IEnum, InferKey, InferValue, LabeledEnum, SimpleEnum };
